...
from tools.my_dataset import BreastDataset
import random
import os
...
# 添加tensorboard，可以查看损失函数的可视化
print("Set your own dirs")
project_dir = "xxx"                                                            # code dir
data_dir = "xxx/BLU_dataset_images/"                                           # BLU dataset dir
...
train_data = BreastDataset(data_dir=data_dir, train=True, transform=train_transform)
test_data = BreastDataset(data_dir=data_dir, train=False, transform=valid_transform)
