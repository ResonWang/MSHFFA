...
from task.Dwt_models._efficientnet_blocks import *
...
def _scale_stage_depth(stack_args, repeats, depth_multiplier=1.0, depth_trunc='ceil'):
    ...
    scaling for other Dwt_models that may have multiple block arg definitions in each stage.
    """
    ...
    def __call__(self, in_chs, model_block_args):
        ...
        for stack_idx, stack_args in enumerate(model_block_args):
            ...
            for block_idx, block_args in enumerate(stack_args):
                ...
                # create the block
                block = self._make_block(block_args, total_block_idx, total_block_count) # 一个DepthwiseSeparableConv Block: dwconv-bn-silu-se-pwconv-bn 或者 InvertedResidual
                blocks.append(block)
